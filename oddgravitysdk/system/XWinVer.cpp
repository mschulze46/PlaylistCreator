...
///////////////////////////////////////////////////////////////////////////////
// IsVistaOrLater
BOOL CXWinVersion::IsVistaOrLater()
{
	if ((m_osinfo.dwPlatformId == VER_PLATFORM_WIN32_NT) && 
		(m_osinfo.dwMajorVersion >= 6))
		return TRUE;
...
///////////////////////////////////////////////////////////////////////////////
// IsSeven
BOOL CXWinVersion::IsSeven()
{
	if ((m_osinfo.dwPlatformId == VER_PLATFORM_WIN32_NT) && 
		((m_osinfo.dwMajorVersion == 6) && (m_osinfo.dwMinorVersion == 1)))
		return TRUE;
...
///////////////////////////////////////////////////////////////////////////////
// IsSevenOrLater
BOOL CXWinVersion::IsSevenOrLater()
{
	if ((m_osinfo.dwPlatformId == VER_PLATFORM_WIN32_NT) && 
		(((m_osinfo.dwMajorVersion == 6) && (m_osinfo.dwMinorVersion > 0)) || 
		(m_osinfo.dwMajorVersion > 6)))
		return TRUE;
