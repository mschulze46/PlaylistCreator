...
// texture alignement
#define KCSB_TEXTURE_LEFT		1
#define KCSB_TEXTURE_RIGHT		2
...
public:
	...
	void				SetTexture(HBITMAP hBitmap, bool bSelfDelete = true, unsigned int uAlignment = KCSB_TEXTURE_LEFT);
