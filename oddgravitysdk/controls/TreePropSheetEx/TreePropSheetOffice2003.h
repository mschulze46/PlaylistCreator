...
/*! @brief TreePropSheetEx with Office 2003 option dialog look and feel.
  ...
  The version of CTreePropSheetEx has the foolowing additions:
 ...
 : public CTreePropSheetEx  
{
	///// members /////
protected:
	BOOL m_bDrawGradientOnCaption;
	BOOL m_bDrawLineOnCaption;

	///// methods /////
public:
	virtual void SetCaptionStyle(BOOL bGradient, BOOL bLine);
